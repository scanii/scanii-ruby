...
client = Scanii::Client.new(key: "your-key", secret: "your-secret", endpoint: "https://api-us1.scanii.com")
...
```ruby
server_client = Scanii::Client.new(key: "k", secret: "s", endpoint: "https://api-us1.scanii.com")
token = server_client.create_auth_token(300)

token_client = Scanii::Client.new(token: token.id, endpoint: "https://api-us1.scanii.com")
token_client.ping
```
